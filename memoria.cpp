...
void mejorAjuste(int p[], int po[], int m[], int n, int j);
void peorAjuste(int p[], int po[], int m[], int n, int j);
...
int main(){
	...
	switch(c){
    	...
    	case 2:
        	mejorAjuste(p,po,m,n,j);//Funcion Mejor Ajuste
        case 3:
        	peorAjuste(p,po,m,n,j);//Funcion Peor Ajuste
    }
